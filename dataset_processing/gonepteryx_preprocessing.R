...
gonepteryx.trials <- read_excel("/home/matteo/own_data/PoD/topics/sos/experimental_data/2022/tested_specimens.xlsx", sheet="gonepteryx")
...
df.gonepteryx <- merge(df.gonepteryx, aggregate(duration~id+n_trial, df.gonepteryx, "sum"), by=c("id","n_trial"))
names(df.gonepteryx)[9] <-"duration"
names(df.gonepteryx)[11] <-"duration_test"
df.gonepteryx$prop_duration <- df.gonepteryx$duration/df.gonepteryx$duration_test
